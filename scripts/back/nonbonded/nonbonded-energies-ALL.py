...
def main ():
    ...
    paramsDir  = args [2]
    outputDir  = "nbenergies"
    PSFFILE	   = "step5_input.psf"
    DCDFILE	   = "step7_0001.dcd"
    OUTNAME    = "nonbonded-energies.csv"
    WORKINGDIR = os.getcwd()

    dirList = os.listdir (inputDir)
    for dir in dirList:
        calculteNonBondedEnergies (inputDir, outputDir, paramsDir, dir, PSFFILE, DCDFILE, WORKINGDIR)
        break

#---------------------------------------------------------------------
#---------------------------------------------------------------------
def calculteNonBondedEnergies (inputDir, outputDir, paramsDir, dir, PSFFILE, DCDFILE,  WORKINGDIR):
