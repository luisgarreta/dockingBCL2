...
energiesDirName = "energies"
ligandsDirName  = "ligands"
...
def main ():
	...
	# Create a file with ligand name
	copyLigandNamesToFiles (ligandsDirName, energiesPaths)
	...
	energiesLines = "\n".join (energiesList)
	open ("Binding_Energies_Table_FULL.csv", "w").writelines (energiesLines)

#--------------------------------------------------------------------
#--------------------------------------------------------------------
def getBindingEnergy (dir):
	ligName = open ("%s/%s" % (dir, "ligand.name")).read ()
