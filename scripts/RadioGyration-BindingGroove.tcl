...
set PROTEIN [atomselect top "residue 105 to 112 or residue 120 to 131"] 
set COMPLEX [atomselect top "residue 105 to 112 or residue 120 to 131 or residue 137 to 155"] 
while {$i < $nf} {
    ...
    puts $outfile "Helix_34, $i, $rogProtein"
    set rogComplex [gyr_radius $COMPLEX]
    puts $outfile "Helix_345, $i, $rogComplex"
} 
