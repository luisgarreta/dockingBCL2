...
puts "-----------------------------------------------------------------------------------------------"
set USAGE "
Extracts all frames from DCD trajectory.
get-all-frames-trajectory.tcl <PSF file> <DCD trajectory>" 
puts "-----------------------------------------------------------------------------------------------"
...
for {set i 0} {$i < $nFrames} {incr i} {
	set frame [atomselect top "all" frame $i]
	set OUTNAME [format "frame%.5d.pdb" $i]
	$frame writepdb $OUTNAME
}
