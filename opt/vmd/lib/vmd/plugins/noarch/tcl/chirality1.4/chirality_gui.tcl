...
#
# $Id: chirality_gui.tcl,v 1.8 2020/05/09 04:22:15 johns Exp $
#

package provide chirality_gui 1.4
...
proc ::chirality::GUI::chirality_gui { } {
  ...
  set lf [labelframe $w.check -bd 2 -relief ridge -text "Check protein or nucleic acid structure for chirality errors" -padx 1m -pady 1m] 
  ...
  set lf [labelframe $w.list -bd 2 -relief ridge -text "Identified chirality errors" -padx 1m -pady 1m] 
  pack $lf -side top -fill x
  ...
  set lf [labelframe $w.atoms -bd 2 -relief ridge -text "Move hydrogen atoms in chiral centers" -padx 1m -pady 1m] 
  pack $lf -side top -fill x
