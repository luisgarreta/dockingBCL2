...
#
# $Id: cgtools.tcl,v 1.19 2021/01/26 07:29:19 johns Exp $
#
package provide cgtools 1.3
...
set NCG 0
for {set i 0} {$i < $NAA} {incr i} {
  set tmpindsel [atomselect $pdbrefID "index $i"]
  set Ntmp [expr int([$tmpindsel get beta])]
  $tmpindsel delete
  if {$Ntmp > $NCG} {
    set NCG $Ntmp
  }
