...
##
## $Id: tkcon-modified.tcl,v 1.15 2020/10/13 20:55:09 johns Exp $
##
...
proc ::tkcon::Init {args} {
	...
	slaveprocs	{
	    ...
	    tkcon_puts tkcon_gets observe observe_var unalias which what
            tkcon_pwd tkcon_gopython
	}
	RCS		{RCS: @(#) $Id: tkcon-modified.tcl,v 1.15 2020/10/13 20:55:09 johns Exp $}
...
## VMD diffs
    foreach {key default} {
	slavealias	{ $OPT(edit) more less tkcon vi vim pico gopython }
    } {
