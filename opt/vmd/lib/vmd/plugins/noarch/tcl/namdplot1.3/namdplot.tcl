...
#
# $Id: namdplot.tcl,v 1.17 2020/08/31 16:48:56 johns Exp $
#
...
proc ::NAMDPlot::guiplot {} {
  ...
  if { $yplotpotential } { lappend ylist "POTENTIAL" }
...
proc ::NAMDPlot::namdplot_gui {} {
  ...
  checkbutton $w.options.yp13 -anchor w -relief groove -width 12 -text "POTENTIAL"  -variable ::NAMDPlot::yplotpotential
