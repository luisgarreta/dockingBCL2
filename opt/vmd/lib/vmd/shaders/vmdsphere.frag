 ...
 *      $Revision: 1.36 $       $Date: 2020/02/24 21:25:51 $
 *
 ***************************************************************************/
///
/// \file vmdsphere.frag
/// \brief VMD OpenGL fragment shader implementing a ray-cast sphere 
/// primitive with per-pixel lighting, phong highlights, etc.  
///
/// The sphere is drawn within the confines of a correctly 
/// transformed bounding cube or viewer-aligned billboard.
...
/// way it is specifically known to be used within VMD.  
/// Certain texturing modes can't actually occur in practice, 
/// so the shader can be simplified relative to what the main fragment 
...
varying vec3 spherepos;       ///< sphere origin
varying vec3 rayorigin;       ///< ray origin
varying float sphereradsq;    ///< sphere rad^2 
